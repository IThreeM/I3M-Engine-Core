...
//! for example cube maps, that may be used for environment mapping. IThreeM supports 1D, 2D,
//! 3D and Cube textures.
//!
//! ## Supported formats
//!
//! To load images and decode them, IThreeM uses image and ddsfile crates. Here is the list of
//! supported formats: png, tga, bmp, dds, jpg, gif, tiff, dds.
//!
//! ## Compressed textures
//!
//! IThreeM supports most commonly used formats of compressed textures: DXT1, DXT3, DXT5.
//!
//! ## Render target
//!
...
use fxhash::FxHasher;
use i3m_core::num_traits::Bounded;
use i3m_core::sparse::AtomicIndex;
...
/// gradients, but compression algorithms used by IThreeM cannot preserve good quality
/// of such gradients.
#[derive(
    Copy,
    Clone,
